...
bool LivingStatus(Progdata &progdata)
{
	...
	case LIVING_MISTGROT:
		...
		printmw(u8"ziet. Je verliest je orïentatiegevoel en stommelt paniekerig door de grot, op\n");
...
void RodeTrolStatus(Progdata &progdata)
{
	...
	{
	case 0:
      printmw(u8"Je hebt de rust van de rode trol verstoord. Hij kijkt zwaar geërgerd.\n\n");
...
void GnoeStatus(Progdata &progdata)
{
	...
	case STATUS_GNOE_GIFTIGVLEESFED:
      printmw(u8"De gnoe ziet het vlees, snuffelt er aan, en slokt het in één hap naar binnen.\n");
...
void DeurStatus(Progdata &progdata)
{
	...
	case STATUS_DEUR_OPEN:
		printmw(u8"Je zet één eind van het bot onder de deur, en op het andere begin je te duwen.\n");
...
void BarbecueStatus(Progdata &progdata)
{
	...
	case STATUS_BARBECUE_KOEKJEBAKING:
      printmw(u8"Een grote rookontwikkeling treedt op wanneer het tweede ingrediënt in de\n");
	  printmw("barbecue belandt.\n");
	  printmw(u8"Knetterend smelten de 2 ingrediënten om tot een koekje.\n\n");
...
void GroenKristalStatus(Progdata &progdata)
{
	...
	{
	case 0:
      printmw(u8"Je struikelt over iets. Door de begroeïing zie je niet wat het is.\n\n");
