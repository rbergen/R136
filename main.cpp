...
void ShowStartMessage(void)
{
	...
	printmw("Het verhaal begint op het moment dat je met drie andere wetenschappers een\n");
	...
	printmw("stoffen compleet in het niets verdwijnen. Een bepaald gedeelte van de reactor\n");
	printmw("loste dan ook op in de lucht, en net op tijd kon een wereldramp voorkomen\n");
	printmw(u8"worden door het heldhaftig optreden van één van je collega's.\n");
	...
	printmw(u8"Eén van de wetenschappers rook onraad en wilde de zaak gaan onderzoeken.\n");
	...
	printmw(u8"zijn reis te coördineren via een geheime radiofrequentie.\n");
	...
	printmw(u8"weerd bordje: \"Betreden op eigen risico\". Je kijkt nog één keer achterom,\n");
